...
from opensast.config import get_settings as _get_settings
from opensast.api.schemas import LoginRequest, TokenResponse, UserCreate, UserOut
...
def logout(
    ...
    from opensast.api.security import blacklist_token, decode_access_token as _decode
