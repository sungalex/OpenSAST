...
내장 엔진을 `opensast.plugins.engine_registry` 에 등록하고, 조회·가용성 점검을
...
from opensast.engines.base import Engine
from opensast.engines.codeql import CodeqlEngine
from opensast.engines.eslint import EslintEngine
