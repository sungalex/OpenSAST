...
| 플러그인 레지스트리 | `aisast/plugins/registry.py` | `Registry[T]` 제네릭, entry_points 자동 발견, `AISAST_PLUGINS_DISABLED` 화이트리스트 |
...
| # | 위치 | Gap | 심각도 |
|---|---|---|---|
| R1 | `rules/opengrep/**` | **MOIS 49 중 13개만 커버** (SR1-1/1-2/1-3/1-4/1-11/1-17/1-18, SR2-4/2-6/2-8/2-11, SR4-1, SR6-2). 나머지 36개 (SR1-5~10/12~16, SR2-1~3/5/7/9~10/12, SR3-*, SR5-*, SR7-*) 미구현 | 🔴 |
| R2 | `rules/codeql/java/` | **`toctou.ql` 1개 파일뿐** — 2nd pass(CodeQL) 실질 가치 거의 없음 | 🔴 |
